-- Clean Install - Removes ALL old data and creates new structure
...
-- Now run the rest of NEW-DATABASE-SCHEMA.sql
-- Or continue below:
...
CREATE POLICY "Public can view businesses by slug" ON businesses FOR SELECT USING (slug IS NOT NULL);
